...
export default function ProjectCard({ 
    ...
    return (
        ...
        >
            <div className={`transition-colors duration-300 relative p-2 border ${outerBorderColor} rounded-3xl flex w-full h-fit md:h-[400px] lg:h-[500px] ${outerBgColor} group`}>
